...
class DifyClient:
    ...
    def workflow_run(self, inputs=None, user="user123", api_key=None, **kwargs):
        """
        触发工作流执行
    ...
    def stream_workflow(self, inputs=None, user="user123", callback=None, api_key=None, **kwargs):
        """
        以流式方式执行工作流
...
if __name__ == "__main__":
    client = DifyClient(api_key='app-nxWuBjy7S969esLGJtPyzdvN',
                        base_url='http://192.168.5.72')
